            ...
            <div className="space-y-4 rounded-md shadow-sm">
              ...
              <div>
                ...
                <input
                  ...
                  type="password"
                  required
                  className="block w-full px-3 py-2 mt-1 tracking-[2px] border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                  value={password}
