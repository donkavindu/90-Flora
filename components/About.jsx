...
const About = ({ id }) => {
  ...
  return (
    <div id={id} className="min-h-[60vh] bg-white w-full py-16">
      <motion.div
        ref={ref}
        className="w-[90%] md:w-[75%] flex flex-col md:flex-row mx-auto items-center h-full gap-16 md:gap-24"
      ...
      >
        ...
        >
          <p className="text-base md:text-[16px] leading-7 md:leading-8">
        ...
        <motion.div
          className="flex flex-col items-center flex-1 w-full text-center md:items-center md:text-center"
          variants={itemVariants}
        >
          <h2 className="text-center md:text-center text-3xl md:text-[36px] font-bold mb-6">
            CHINTHAKA KASUN
          </h2>
          <p className="text-base md:text-[16px] leading-6">
            Founder at 90Flora
            <br />
